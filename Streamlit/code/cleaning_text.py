# -*- coding: utf-8 -*-
"""
Created on Sun Mar 13 14:41:25 2022
...
def createdfManuel(description, designation):
  dic={"designation":[description],"description":[designation]}
  dataTxt = pd.DataFrame(dic)
  return dataTxt
