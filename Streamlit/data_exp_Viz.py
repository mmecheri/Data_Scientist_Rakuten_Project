...
def read_page_text(text_page):
        ...
        #st.subheader("Exploration des données Texte")
        ...
        with open(text_page, 'r', encoding='utf-8') as txtpage: 
            ...
            # with col5:
            #     image5 = Image.open('./doc/classe_1140_WC.png')
            #     st.image(image5, use_column_width='auto')
            # with col6:
            #    image6 = Image.open('./doc/classe_1140_imgs.png')
            #    st.image(image6, use_column_width='auto')
               
            # st.markdown(txtpage[4], unsafe_allow_html=True)
            
            # image7 = Image.open('./doc/small_imgs.png')
         ...
         # with col7:
          ...
          #♦st.markdown(txtpage[2], unsafe_allow_html=True)
            ...
            agree1 = st.checkbox('Afficher plus de détails')
            if agree1:
